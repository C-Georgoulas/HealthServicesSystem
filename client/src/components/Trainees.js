        ...
        <div className={classes.searchContainer}>
          ...
          <FormControl variant="outlined" className={classes.filterBar}>
            ...
            >
              ...
              <MenuItem value={"Assigned Supervisors"}>
                  ...
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="right">
                        <strong>Traineeship Start</strong>
                      </TableCell>
                      <TableCell align="right">
                        <strong>Average Grade</strong>
                      </TableCell>
                      <TableCell align="right">
                        <strong>Supervising Instructor</strong>
                      </TableCell>
                      <TableCell align="right">
