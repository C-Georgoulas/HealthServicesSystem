      ...
      <Container maxWidth="md">
            ...
            <CardActions>
              ...
              {user.role === "admin" && (
                <Button
                  ...
                  variant="outlined"
                  component={Link}
                  to={`/patients/${patient._id}/prescription/new`}
                >
                  ADD A PRESCRIPTION
                </Button>
              )}
              ...
              {user.role === "admin" && (
                <Button
                  ...
                  variant="outlined"
                  component={Link}
                  to={`/patients/${patient._id}/surgery/new`}
                >
                  PLAN A SURGERY
                </Button>
              )}
              ...
              {patient.status === "Active" && (
                <Button
                  ...
                  color="primary"
                  variant="outlined"
                  onClick={onDeactivePatientSubmit}
                >
                  DE-ACTIVATE PATIENT
                </Button>
              )}
              {patient.status === "Inactive" && (
                <Button
                  ...
                  color="primary"
                  variant="outlined"
                  onClick={onActivatePatientSubmit}
                >
                  ACTIVATE PATIENT
                </Button>
              )}
                  ...
                  {patient.prescriptions &&
                    patient.prescriptions.map((prescription) => (
                      <TableRow key={prescription._id}>
                        ...
                        {prescription.author &&
                          prescription.author.name != undefined && (
                            <TableCell align="right">
                      ...
                      <>
                        <TableBody>
                          {patient.surgeries
                            .filter((surgery) => {
                              return (
                                dateSurgery(surgery.startDate) === "Scheduled"
                              );
                            })
                            .map((surgery) => (
                      ...
                      <>
                        <TableBody>
                          {patient.surgeries
                            .filter((surgery) => {
                              return (
                                dateSurgery(surgery.startDate) === "Concluded"
                              );
                            })
                            .map((surgery) => (
                              <TableRow key={surgery._id}>
                      ...
                      <ListItem alignItems="flex-start">
                          ...
                          secondary={
                            <React.Fragment>
                              ...
                              >
                                {note.author && note.author.name != undefined && (
                                  <>
                                    {capitalizeFirstLetter(note.author.role) +
                                      " " +
                                      "(" +
                                      note.author.department +
                                      ")"}{" "}
                                    {" " + note.author.name}
                                  </>
                                )}
                        ...
                        {note.author._id === user._id && (
                          <ListItemSecondaryAction
                            className={classes.noteActionPos}
                          >
                            <Tooltip title="Modify">
                              <IconButton
                                aria-label="modify"
                                size="small"
                                onClick={() => handleClickOpenEditNote(note)}
                              >
                                <EditIcon />
                              </IconButton>
                            </Tooltip>
        ...
        >
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>
                To add a medical note to {patient.fullName}, please fill out the
                form below.
              </DialogContentText>
              <TextValidator
                autoFocus
        ...
        >
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>
                To edit the medical note for {patient.fullName}, please fill out
                the form below.
              </DialogContentText>
              <TextValidator
                autoFocus
