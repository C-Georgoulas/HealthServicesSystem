...
export default function TraineeCreate(props) {
  ...
  const [trainee, setTrainee] = useState({ status: "Active" });
  ...
  const handleClick2 = (user) => {
    setTrainee({ ...trainee, author: user });
  };
            ...
            <CardContent>
              ...
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  onChange={(e) =>
                    setTrainee({ ...trainee, fullName: e.target.value })
                  }
                  validators={["required"]}
              ...
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  name="trainee[age]"
                  onChange={(e) =>
                    setTrainee({ ...trainee, age: e.target.value })
                  }
                  value={trainee.age}
                  validators={["required"]}
