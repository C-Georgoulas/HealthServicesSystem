          ...
          <Card className={classes.root} variant="outlined">
            <CardContent>
              <Typography variant="h6" component="h2">
                {patient.fullName} -{" "}
                <span style={{ color: "gray" }}>New Surgery</span>
              </Typography>
              <Divider />
              ...
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  onChange={(e) =>
                    setSurgery({ ...surgery, title: e.target.value })
                  }
                  validators={["required"]}
                  errorMessages={[
                    "Please add the short title of the body part the surgery will be performed!",
                  ]}
                />
              </Typography>
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  rows={4}
                  onChange={(e) =>
                    setSurgery({ ...surgery, text: e.target.value })
                  }
                  validators={["required"]}
              ...
              >
                {users &&
                  ...
                  users
                    .filter((user) => {
                      return departmentChecker(user.department) === "surgeon";
                    })
                    .map((user) => (
                      <MenuItem
                        key={user._id}
