        ...
        <Card className={classes.root}>
          ...
          <CardContent>
            <Typography variant="body2" color="textSecondary" component="p">
              Welcome back! Please remember to check your tasks and
              notifications for any updates you may have missed.
            </Typography>
          </CardContent>
                    ...
                    <>
                      {notifications
                        .filter((notification, index) => {
                          return (
                            readNotification(notification.read) === "Not Read"
                          );
                        })
                ...
                <List dense={dense}>
                  {notifications && notifications.length > 0 && (
                    <>
                      {notifications
                        .filter((notification, index) => {
                          return readNotification(notification.read) === "Read";
                        })
                        .map((notification, index) => (
                          <>
                            {notification.isNoteNotification && (
