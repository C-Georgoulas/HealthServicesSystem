      ...
      <Container maxWidth="md">
            ...
            <CardActions>
              ...
              {trainee.status === "Active" && (
                <Button
                  ...
                  color="primary"
                  variant="outlined"
                  onClick={onDeactiveTraineeSubmit}
                >
                  DE-ACTIVATE TRAINEE
                </Button>
              )}
              {trainee.status === "Inactive" && (
                <Button
                  ...
                  color="primary"
                  variant="outlined"
                  onClick={onActivateTraineeSubmit}
                >
                  ACTIVATE TRAINEE
                </Button>
              )}
                          ...
                          >
                            <Tooltip title="Modify">
                              <IconButton
                                aria-label="modify"
                                size="small"
                                onClick={() => handleClickOpenEditGrade(grade)}
                              >
                                <EditIcon />
                              </IconButton>
                            </Tooltip>
        ...
        >
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>
                To add a grade report to {trainee.fullName}, please fill out the
                form below.
              </DialogContentText>
              <TextValidator
                autoFocus
        ...
        >
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>
                To edit the grade report for {trainee.fullName}, please fill out
                the form below.
              </DialogContentText>
              <TextValidator
                margin="dense"
                ...
                name="grade[title]"
                onChange={(e) =>
                  setEditGrade({ ...editGrade, title: e.target.value })
                }
                validators={["required"]}
              ...
              <TextValidator
                ...
                name="grade[mark]"
                onChange={(e) =>
                  setEditGrade({ ...editGrade, mark: e.target.value })
                }
              ...
              <TextValidator
                ...
                onChange={(e) =>
                  setEditGrade({ ...editGrade, text: e.target.value })
                }
                validators={["required"]}
