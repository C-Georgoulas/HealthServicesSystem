...
export default function PrescriptionCreate({ match }, props) {
  ...
  const drugsByCategoryName = groupBy(drugs, (drug) =>
    drug.class.toLowerCase()
  );
          ...
          <Card className={classes.root} variant="outlined">
            <CardContent>
              <Typography variant="h6" component="h2">
                {patient.fullName} -{" "}
                <span style={{ color: "gray" }}>New Prescription</span>
              </Typography>
              <Divider />
              ...
              <FormControl className={classes.formControl}>
                ...
                <Select
                  ...
                  renderValue={() => renderValue(prescription.drug)}
                >
