...
// works for now!
useEffect(() => {
     fetch(`/api/patients/${data.state.passedPatientId}/prescriptions/${match.params.id}/edit`)
...
const onEditedPrescriptionSubmit = (e) => {
    ...
    fetch(`/api/patients/${data.state.passedPatientId}/prescriptions/${match.params.id}`, {
      method: 'PUT',
...
return (
  <div>
    ...
    <Container maxWidth="md">
        <form className={classes.root} noValidate autoComplete="off" onSubmit={onEditedPrescriptionSubmit}>
    <Card className={classes.root} variant="outlined">
  <CardContent>
  <Typography variant="h6" component="h2">
     {patient.fullName} - <span style={{color: 'gray'}}>Edit Prescription</span>
  </Typography>
  <Divider />
