...
export default function TraineeCreate(props) {
  ...
  const handleClick2 = (user) => {
    setEditTrainee({ ...editTrainee, author: user });
  };
            ...
            <CardContent>
              ...
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  onChange={(e) =>
                    setEditTrainee({ ...editTrainee, fullName: e.target.value })
                  }
                  validators={["required"]}
              ...
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  onChange={(e) =>
                    setEditTrainee({ ...editTrainee, age: e.target.value })
                  }
              ...
              {editTrainee.author && editTrainee.author.name != undefined && (
                <Select
                  ...
                  validators={["required"]}
                  errorMessages={[
                    "Please select the instructor of the trainee!",
                  ]}
                >
                  {users &&
                    users.length > 1 &&
                    users
                      .filter((user) => {
                        return roleChecker(user.role) === "instructor";
                      })
                      .map((user) => (
                        <MenuItem
                          key={user._id}
