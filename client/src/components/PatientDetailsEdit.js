...
export default function PatientDetailsEdit({ match }) {
  ...
  const handleClick2 = (user) => {
    setEditPatient({ ...editPatient, author: user });
  };
            ...
            <CardContent>
              ...
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  onChange={(e) =>
                    setEditPatient({ ...editPatient, weight: e.target.value })
                  }
              ...
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  validators={["required"]}
                  errorMessages={[
                    "Please select the condition of the patient!",
                  ]}
                >
              ...
              <Divider />
              <InputLabel className={classes.sex} id="demo-simple-select-label">
                SUPERVISING DOCTOR
              </InputLabel>
              {editPatient.author && editPatient.author.name != undefined && (
                ...
                >
                  {users &&
                    ...
                    users
                      .filter((user) => {
                        return roleChecker(user.role) === "doctor";
                      })
                      .map((user) => (
                        <MenuItem
                          key={user._id}
                          value={user}
                          onClick={() => handleClick2(user)}
                        >
                          {user.name}
                        </MenuItem>
                      ))}
              ...
              <Typography variant="body2" component="p">
                <TextValidator
                  ...
                  validators={["required"]}
                  errorMessages={[
                    "Please select the department of the patient!",
                  ]}
                >
